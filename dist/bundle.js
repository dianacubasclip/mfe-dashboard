	...
	*/
	...
	function _e(e, n, r, o) {
	  ...
	  if (E(e)) {
	    ...
	    var u = e(n);
	    return reactIs$1.exports.isElement(u) && console.warn(b(e) + " is not a styled component and cannot be referred to via component selector. See https://www.styled-components.com/docs/advanced#referring-to-other-components for more details."), _e(u, n, r, o);
	  }
	...
	var Ce = /invalid hook call/i,
	    ...
	    Pe = function (e, t) {
	  {
	    ...
	    try {
	      ...
	      }, react.exports.useRef(), o && !Ie.has(n) && (console.warn(n), Ie.add(n));
	    } catch (e) {
	...
	function Ye(e, t, n) {
	  ...
	  }), (Pe(v, g), C.warnTooManyClasses = function (e, t) {
	    var n = {},
	        r = !1;
	    return function (o) {
...
`;
	...
	const CentralComponent = props => {
	  ...
	  const tabs = [{
	    label: 'tab1',
	    component: () => /*#__PURE__*/React.createElement("div", null, "Componente gen\xE9rico 1")
	  }, {
	    label: 'tab2',
	    component: () => /*#__PURE__*/React.createElement("div", null, "Componente gen\xE9rico 2")
	  }, {
	    label: 'tab3',
	    component: () => /*#__PURE__*/React.createElement("div", null, "Componente gen\xE9rico 3")
	  }, {
	    label: 'tab4',
	    component: () => /*#__PURE__*/React.createElement(ThirdPartyComponent, null)
	  }];
	  const [currentTab, setCurrentTab] = react.exports.useState(initialTab || 0);
	  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(StyledTabsContainer, null, tabs.map((tab, index) => /*#__PURE__*/React.createElement(StyledTab, {
	    key: tab.label,
	    ...
	    id: "dashboard-central-tab-content"
...
`;
	...
	const DashboardLayout = () => {
	  return /*#__PURE__*/React.createElement(StyledContainer, null, /*#__PURE__*/React.createElement(StyledTopComponent, null, "usgusg"), /*#__PURE__*/React.createElement(StyledBottomContainer, null, /*#__PURE__*/React.createElement(StyledRightContainer, null, /*#__PURE__*/React.createElement(CentralComponent, null)), /*#__PURE__*/React.createElement(StyledLeftContainer, null, /*#__PURE__*/React.createElement(StyledLeftComponent, null), /*#__PURE__*/React.createElement(StyledLeftComponent, null), /*#__PURE__*/React.createElement(StyledLeftComponent, null), /*#__PURE__*/React.createElement(StyledLeftComponent, null))));
	};

	function App() {
	  return /*#__PURE__*/React.createElement("div", {
	    className: "App"
	  }, /*#__PURE__*/React.createElement(DashboardLayout, null));
	}
